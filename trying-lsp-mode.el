...
;;       ((setq clients (lsp--filter-clients #'lsp--supports-buffer?))
...
(advice-add 'lsp--start-workspace :around #'diff-lsp--start-workspace)
;; commented for when i need to cleanup.
...
;; (advice-add 'lsp-resolve-final-command :around #'diff-lsp--lsp-resolve-final-command)
